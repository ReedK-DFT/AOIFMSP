...
export async function tenants(request: HttpRequest, context: InvocationContext) {
...
export async function tenantDetail(request: HttpRequest, context: InvocationContext) {
  logRequest(context, request);
