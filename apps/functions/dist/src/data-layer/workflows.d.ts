import type { ApprovalMode, AuditedEntity, BlobPath, JsonObject, JsonValue, StartedByType, TableEntityAddress, TableSystemFields, WorkflowApprovalPolicy, WorkflowTriggerType } from './common';
...
export type WorkflowNodeType = 'trigger' | 'connector-action' | 'condition' | 'loop' | 'data-transform' | 'variable' | 'javascript' | 'ai-agent';
...
export type WorkflowNode = TriggerWorkflowNode | ConnectorActionWorkflowNode | ConditionWorkflowNode | LoopWorkflowNode | DataTransformWorkflowNode | VariableWorkflowNode | JavaScriptWorkflowNode | AIAgentWorkflowNode;
